...
private:
    struct CapturedClient {
        class OverviewFrame* owner = nullptr;
    ...
    static void handle_buffer(void* data, struct hyprland_toplevel_export_frame_v1* export_frame, uint32_t format, uint32_t width, uint32_t height, uint32_t stride);
    static void handle_damage(void* data, struct hyprland_toplevel_export_frame_v1* export_frame, uint32_t x, uint32_t y, uint32_t width, uint32_t height);
    static void handle_flags(void* data, struct hyprland_toplevel_export_frame_v1* export_frame, uint32_t flags);
    static void handle_ready(void* data, struct hyprland_toplevel_export_frame_v1* export_frame, uint32_t tv_sec_hi, uint32_t tv_sec_lo, uint32_t tv_nsec);
    static void handle_failed(void* data, struct hyprland_toplevel_export_frame_v1* export_frame);
    static void handle_linux_dmabuf(void* data, struct hyprland_toplevel_export_frame_v1* export_frame, uint32_t format, uint32_t width, uint32_t height);
